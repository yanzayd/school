...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <%
            ...
            {
        %>
        <jsp:include page="view/autable.jsp"/>
         ...
         %>
          <%
            ...
            {
        %>
        <jsp:include page="view/auuser.jsp"/>
        ...
        <%
            ...
            {
        %>
        <jsp:include page="view/stuser.jsp"/>
        ...
        <%
            ...
            {
        %>
        <jsp:include page="view/sttable.jsp"/>
        ...
        <%
            ...
            {
        %>
        <jsp:include page="view/teauser.jsp"/>
        ...
        <%
            ...
            {
        %>
        <jsp:include page="view/teatable.jsp"/>
         ...
         <%
            ...
            {
        %>
        <jsp:include page="view/tiuser.jsp"/>
        ...
        <%
            ...
            {
        %>
        <jsp:include page="view/titable.jsp"/>
